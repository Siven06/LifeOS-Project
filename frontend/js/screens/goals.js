const goalsScreen = {
  async render() {
        ...
        <nav class="bg-surface-container/90 backdrop-blur-2xl fixed bottom-0 w-full z-50 rounded-t-xl border-t border-white/10 h-[72px]">
          <div class="max-w-lg mx-auto h-full flex items-stretch px-2 relative">
            ...
            <div class="flex items-center justify-center flex-[0.8] relative">
              <button id="fab-add-goal" class="absolute -top-5 bg-primary-container text-on-primary w-12 h-12 rounded-full center-button-glow active:scale-90 hover:scale-105 transition-all shadow-lg shadow-primary-container/30 flex items-center justify-center">
    ...
    document.getElementById('fab-add-goal')?.addEventListener('click', () => this.showGoalModal());
